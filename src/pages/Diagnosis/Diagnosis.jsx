        ...
        contents={[
          {
            ...
            description: [
              ...
              '-풍해(바람이 너무많이 붐) 바람이 적은 곳으로 옮긴다. 잎 가장자리가 굽는다.',
            ],
          },
          {
            title: '잎잎의 반점과 변색이 생긴 때',
            description: [
              '-약해, 물을 충분히 준다. 빛이 약한 곳으로 옮겨주어야 효과적이다.',
              '-냉해 (저온에 노출) 따뜻한 곳으로 옮긴다. 갑자기 옮기면 잎이 뭉그러질 수 있으니 주의한다.',
              '-병충해, 해당 살균제를 살포한다. 탄저병, 반점병약을 지시된 양으로 희석하여 2~3회 정도 살포',
            ],
          },
        ]}
      />
      ...
      <DiagnosisForm
        ...
        contents={[
          ...
          },
          {
            ...
            description: [
              '-일조량의 과다. 빛이 약한 곳으로 옮긴다.',
              '-수분의 부족, 공중습도가 높은 곳으로 옮기고 충분한 물 주기',
            ],
          },
          {
